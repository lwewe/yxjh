<template>
  <div class="list-container">
    <el-card class="search-card serchForm">
      客户名称：{{ cardInfo.company || '' }}
    </el-card>

    <el-card class="search-card">
      <el-form :model="purviewForm" class="search-form" style="text-align: left;" label-width="130px" v-loading="loading">
        <!-- 首页图标 -->
        <el-form-item label="首页图标：">
          <el-checkbox :indeterminate="sytbIndeterminate" v-model="sytbCheckAll" @change="handleSytbCheckAll">全选</el-checkbox>
        ...
        <el-form-item label="首页推荐：">
          <el-checkbox :indeterminate="sytjIndeterminate" v-model="sytjCheckAll" @change="handleSytjCheckAll">全选</el-checkbox>
          <div style="margin: 15px 0;"></div>
          <el-checkbox-group v-model="purviewForm.sytj" @change="handleSytjChange">
            <el-checkbox v-for="item in productFenSytj" :label="item.id" :key="item.id">{{ item.syname || item.name }}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
...
.serchForm .el-card__body { text-align: left; }
.serchForm .el-input__icon { line-height: 36px; }
.serchForm .el-form-item__content { line-height: 36px; }
.serchForm .el-form-item__label { line-height: 36px; }
</style>
