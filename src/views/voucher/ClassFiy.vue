          ...
          <el-form :inline="true" class="search-form">
            ...
            <el-form-item label="">
              <el-select v-model="filterForm.class2" placeholder="二级分类" clearable style="width:130px;">
                <el-option label="粮油副食" value="163"></el-option>
                <el-option label="休闲零食" value="164"></el-option>
                <el-option label="清洁洗护" value="165"></el-option>
                <el-option label="悦享生活" value="166"></el-option>
                <el-option label="严选好物" value="167"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="">
