  ...
  <div class="list-container">
    ...
    <el-card class="search-card">
      <div style="text-align: left; margin-bottom: 20px;">
        <el-button type="primary" size="small" icon="el-icon-plus" @click="addPro()">添加首页轮播图</el-button>
      </div>
      <el-table ref="multipleTable" :data="tableData" border tooltip-effect="dark" style="width: 100%"
        ...
        <el-table-column label="排序" width="180" align="center">
          <template slot-scope="scope">
            <el-input v-model="scope.row.dj" size="mini"></el-input>
          </template>
        </el-table-column>

        <el-table-column label="图片" width="160" align="center">
          <template slot-scope="scope">
            <img src="../../assets/22.png" style="width: 90px;" alt="">
          </template>
        </el-table-column>
        <el-table-column label="标题" align="center">
          <template slot-scope="scope">
            <span class="blueCl">{{ scope.row.mb }}</span> {{ scope.row.fb }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="添加时间" align="center">
          <template slot-scope="scope">
            <img src="../../assets/26.png" style="width: 90px;" alt="">
          </template>
        </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      tableData: [{
        dj: '5', mb: '[模板一]', fb: '端午节', fb1: '北京如果未来科技有限公司', yj: '[节日慰问]', yj1: '[清洁洗护]',
        ...
        dj: '5', fb: '端午节', mb: '[模板一]', fb1: '北京如果未来科技有限公司', yj: '[节日慰问]', yj1: '[清洁洗护]',
