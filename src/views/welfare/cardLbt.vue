    ...
    <el-card class="search-card">
      ...
      <el-table ref="multipleTable" :data="tableData" border v-loading="loading"
        ...
        <el-table-column label="图片" width="160" align="center">
          <template slot-scope="scope">
            <el-image v-if="scope.row.img" :src="scope.row.img" style="width:120px;height:60px;" fit="contain"
...
export default {
  ...
  methods: {
    ...
    async handleFb(row) {
      ...
      try {
        await this.$confirm(`确认${actionText}该轮播图吗？`, '提示', {
